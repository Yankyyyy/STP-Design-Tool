function degreesToRadians(degrees) {
  ...
  export const calculateMediumScreenDesign = (inputs) => {
    ...
    const computedLengthOfTheScreenChannelMM = 2 * ( 5 * widthOfTheScreenMM ) + ( ( parseFloat(depthOfWaterInScreenM) + parseFloat(freeBoardM) ) * 1000 * ( 1 / Math.tan(angleOfInclinationWithTheHorizontalRad)));
    ...
    return {
      ...
      computedLengthOfTheScreenChannelMM: computedLengthOfTheScreenChannelMM.toFixed(3),
